...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        OverviewPage->setStyleSheet(QString::fromUtf8("QWidget { color: violet; }"));
        ...
        labelAlerts->setStyleSheet(QString::fromUtf8("background-color:#FFFFFF;"));
        ...
        labelWalletStatus->setStyleSheet(QString::fromUtf8("QLabel { color: violet; }"));
        ...
        labelBalance->setFont(QString::fromUtf8("123.4567 BSH"));
        ...
        labelUnconfirmed->setText(QString::fromUtf8("0 BSH"));
        ...
        formLayout_2->setWidget(2, QFormLayout::FieldRole, labelNumTransactions);
        ...
        labelPending = new QLabel(frame);
        labelPending->setObjectName(QString::fromUtf8("labelPending"));
        labelPending->setFont(font);
        labelPending->setText(QString::fromUtf8("0 BSH"));

        formLayout_2->setWidget(3, QFormLayout::FieldRole, labelPending);
        ...
        label_bg = new QLabel(OverviewPage);
        label_bg->setObjectName(QString::fromUtf8("label_bg"));
        label_bg->setPixmap(QPixmap(QString::fromUtf8(":/images/splash")));
        label_bg->setScaledContents(false);
        label_bg->setAlignment(Qt::AlignCenter);
        label_bg->setMargin(-2);

        verticalLayout_2->addWidget(label_bg);
        ...
        labelTransactionsStatus->setStyleSheet(QString::fromUtf8("QLabel { color: violet; }"));
        ...
        listTransactions->setVerticalScrollBarPolicy(Qt::ScrollBarAlwaysOn);
        listTransactions->setHorizontalScrollBarPolicy(Qt::ScrollBarAlwaysOn);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "UPDATEFIELD:The displayed information may be out of date. Your wallet automatically synchronizes with the BitShekel network after a connection is established, but this process has not completed yet.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("OverviewPage", "Balance \342\232\226:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        labelBalance->setToolTip(QApplication::translate("OverviewPage", "Your current balance", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label_3->setText(QApplication::translate("OverviewPage", "Unconfirmed \342\216\214:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OverviewPage", "Total \342\207\265:", 0, QApplication::UnicodeUTF8));
        labelNumTransactions->setText(QApplication::translate("OverviewPage", "0", 0, QApplication::UnicodeUTF8));
        labelImmatureText->setText(QApplication::translate("OverviewPage", "Pending \342\232\222:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        labelPending->setToolTip(QApplication::translate("OverviewPage", "Mined balance that has not yet matured", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
