...
public:
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        AddressBookPage->setStyleSheet(QString::fromUtf8("QWidget { color: violet; }"));
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/images/qrcode"), QSize(), QIcon::Normal, QIcon::On);
    ...
    {
        AddressBookPage->setWindowTitle(QApplication::translate("AddressBookPage", "Address Book \356\200\221", 0, QApplication::UnicodeUTF8));
        labelExplanation->setText(QApplication::translate("AddressBookPage", "These are your BitShekel addresses for receiving payments.  You may want to give a different one to each sender so you can keep track of who is paying you.", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        tableView->setToolTip(QApplication::translate("AddressBookPage", "Double-click to add/edit address label", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        newAddressButton->setToolTip(QApplication::translate("AddressBookPage", "Pulls another address for sending and/or receiving transactions", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        newAddressButton->setText(QApplication::translate("AddressBookPage", "&Address Puller", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
