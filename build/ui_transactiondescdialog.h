...
**
** Created: Sun Apr 27 13:29:50 2014
...
public:
    ...
    {
        TransactionDescDialog->setStyleSheet(QApplication::translate("TransactionDescDialog", "QDialogButtonBox { color: violet; }", 0, QApplication::UnicodeUTF8));
