...
contains(BITSHEKEL_NEED_QT_PLUGINS, 1) {
    DEFINES += BITSHEKEL_NEED_QT_PLUGINS
...
SOURCES += src/qt/BitShekel.cpp src/qt/BitShekelgui.cpp \
...
contains(BITSHEKEL_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/urltests.cpp
HEADERS += src/qt/test/urltests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = BitShekel-qt_test
DEFINES += BITSHEKEL_QT_TEST
}

CODECFORTR = UTF-8

# for lrelease/lupdate
# also add new translations to src/qt/BitShekel.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/BitShekel_*.ts)
...
windows:RC_FILE = src/qt/res/BitShekel-qt.rc
...
macx:ICON = src/qt/res/icons/BitShekel.icns
