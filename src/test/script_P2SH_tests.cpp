...
BOOST_AUTO_TEST_CASE(sign)
{
    ...
    standardScripts[1].SetBitshekelAddress(key[1].GetPubKey());
    standardScripts[2] << key[1].GetPubKey() << OP_CHECKSIG;
    standardScripts[3].SetBitshekelAddress(key[2].GetPubKey());
...
BOOST_AUTO_TEST_CASE(set)
{
    ...
    CScript inner[4];
    inner[0].SetBitshekelAddress(key[0].GetPubKey());
...
BOOST_AUTO_TEST_CASE(AreInputsStandard)
{
    ...
    CScript pay1; pay1.SetBitshekelAddress(key[0].GetPubKey());
    ...
    CTransaction txTo;
    txTo.vout.resize(1);
    txTo.vout[0].scriptPubKey.SetBitshekelAddress(key[1].GetPubKey());
    ...
    txToNonStd.vout[0].scriptPubKey.SetBitshekelAddress(key[1].GetPubKey());
