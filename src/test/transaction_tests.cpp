...
SetupDummyInputs(CBasicKeyStore& keystoreRet, MapPrevTx& inputsRet)
{
    ...
    dummyTransactions[1].vout[0].scriptPubKey.SetBitshekelAddress(key[2].GetPubKey());
    dummyTransactions[1].vout[1].nValue = 22*CENT;
    dummyTransactions[1].vout[1].scriptPubKey.SetBitshekelAddress(key[3].GetPubKey());
