...
#ifndef BITSHEKEL_MAIN_H
#define BITSHEKEL_MAIN_H
...
static const int64 MIN_TX_FEE = 10000000; // BitShekel: minimum transaction fee of 0.1 BSH
static const int64 MIN_RELAY_TX_FEE = MIN_TX_FEE; // BitShekel: minimum relay transaction fee same as minimum transaction fee.
static const int64 MAX_MONEY = 84000000 * COIN; // BitShekel: maximum of 84M coins
...
public:
    ...
    */
    ...
    /** Amount of BitShekelim spent by this transaction.
    ...
    /** Amount of BitShekelim coming in to this transaction
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 1 * COIN * 576 / 250; // BitShekel: 576 blocks found a day. Priority cutoff is 1 BitShekel day / 250 bytes.
    }
