...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(): QAbstractItemDelegate(), unit(BitshekelUnits::BTC)
    {
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = BitshekelUnits::formatWithUnit(unit, amount, true);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(qint64 balance, qint64 unconfirmedBalance)
{
    ...
    ui->labelUnconfirmed->setText(BitshekelUnits::formatWithUnit(unit, unconfirmedBalance));
}
