...
{
    // Until signal notifications is built into the BitShekel core,
...
// BitShekel: copied from BitShekelrpc.cpp.
...
void ClientModel::setMining(MiningType type, bool mining, int threads, int hashrate)
{
    ...
    {
//            GenerateBitshekelim(mining ? 1 : 0, getOptionsModel()->getWallet());
    }
    miningType = type;
